<?php
// resources/views/dietitian/foods/items/create.blade.php
?>

<x-app-layout title="Add Food Item" is-header-blur="true">
            ...
            <div class="col-span-12 lg:col-span-8">
                <div class="card">
                    ...
                    <div class="p-4 sm:p-5">
                        ...
                        <form action="{{ route('dietitian.foods.items.store') }}" method="POST" class="space-y-5">
                            @csrf
            ...
            <div class="col-span-12 lg:col-span-4">
                <div class="card">
                    ...
                    <div class="p-4 sm:p-5 text-sm text-slate-600 dark:text-navy-300 space-y-2">
                        <p>Choose consistent units for accurate dietary calculations.</p>
                        <p>Food categories help organize your list and make planning easier.</p>
                    </div>
                </div>
            </div>
        </div>
