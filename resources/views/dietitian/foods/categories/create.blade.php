<x-app-layout title="Add Food Category" is-header-blur="true">
    <main class="main-content w-full px-[var(--margin-x)] pb-8">
        <div class="flex items-center justify-between mt-5 mb-5">
            <h1 class="text-xl font-medium text-slate-700 dark:text-navy-100">Add Food Category</h1>
        ...
        <form action="{{ route('dietitian.foods.categories.store') }}" method="POST"
