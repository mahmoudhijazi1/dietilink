            ...
            <div class="col-span-12">
                <div class="card" x-data="patientCreateForm()">
                    ...
                    <div class="p-4 sm:p-5">
                        ...
                        <form method="POST" action="{{ route('dietitian.patients.store') }}" 
                            ...
                            <div class="space-y-6">
                                <div class="flex items-center space-x-3 mb-6">
                                    ...
                                    <div>
                                        <h3 class="text-base font-semibold text-slate-800 dark:text-navy-50">Account Credentials</h3>
                                        <p class="text-sm text-slate-500 dark:text-navy-300">Login information for the patient</p>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    ...
                                    <label class="block">
                                        ...
                                        <span class="text-xs text-slate-500 block mt-1">This will be used for login</span>
                                        <div class="relative mt-2">
                                            ...
                                            <div class="absolute right-3 top-1/2 -translate-y-1/2">
                                                <!-- Loading Spinner -->
                                                <svg x-show="isCheckingUsername" class="animate-spin size-5 text-slate-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                                </svg>
                                                
                                                <!-- Success Icon -->
                                                <svg x-show="!isCheckingUsername && usernameStatus === true" class="size-5 text-success" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                                </svg>
                                                
                                                <!-- Error Icon -->
                                                <svg x-show="!isCheckingUsername && usernameStatus === false" class="size-5 text-error" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <!-- Status Message -->
                                        <div x-show="usernameMessage" class="mt-2 text-sm" 
                                             :class="{
                                    ...
                                    <label class="block">
                                        ...
                                        <div class="relative mt-2">
                                            ...
                                            <button type="button" 
                                                ...
                                                <svg x-show="!showPassword" xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
                                                </svg>
                                                <svg x-show="showPassword" xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="display: none;">
                            ...
                            <div class="space-y-6">
                                <div class="flex items-center space-x-3 mb-6">
                                    ...
                                    <div>
                                        <h3 class="text-base font-semibold text-slate-800 dark:text-navy-50">Personal Information</h3>
