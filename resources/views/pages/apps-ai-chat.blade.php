                ...
                <div class="flex h-[calc(100%-4.5rem)] grow flex-col">
                    ...
                    <div class="flex flex-col grow overflow-hidden">
                        ...
                        <div class="overflow-y-auto is-scrollbar-hidden min-w-0 px-2 pt-1">
                            <div role="button"
                                class="group flex space-x-2 w-full min-w-0 items-start justify-start p-2 text-xs+ rounded-lg tracking-wide text-slate-800 outline-none transition-all hover:bg-slate-100 focus:bg-slate-100 dark:text-navy-100 dark:hover:bg-navy-600 dark:focus:bg-navy-600">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" aria-hidden="true" data-slot="icon"
    ...
    <main class="main-content chat-app h-100vh mt-0 flex flex-col w-full min-w-0 supports-[height:1dvh]:h-dvh">
        <div
                    ...
                    <div x-ref="popperRoot" class="popper-root" :class="isShowPopper && 'show'">
                        <div
                            ...
                            <ul>
                                <li>
                                    <a href="#"
                                        class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">ChatGPT
                                        3</a>
                                </li>
                                <li>
                                    <a href="#"
                                ...
                                <li>
                                    <a href="#"
                                        class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Copilot</a>
                                </li>
                                <li>
                                    <a href="#"
                                        class="flex h-8 items-center px-3 pr-8 font-medium tracking-wide outline-none transition-all hover:bg-slate-100 hover:text-slate-800 focus:bg-slate-100 focus:text-slate-800 dark:hover:bg-navy-600 dark:hover:text-navy-100 dark:focus:bg-navy-600 dark:focus:text-navy-100">Copilot
                                        Pro</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="flex space-x-3 items-center">
                ...
                <button class="btn space-x-2 bg-gradient-to-r from-green-400 to-blue-600 font-medium text-white">
